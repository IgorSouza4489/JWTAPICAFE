using Core.Models;
using JWTAPICAFE.Configuration;
...
namespace JWTAPICAFE.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IOptions<JwtBearerTokenSettings> jwtTokensOptions, UserManager<IdentityUser> userManager)
        {
            this.jwtBearerTokenSettings = jwtTokensOptions.Value;
